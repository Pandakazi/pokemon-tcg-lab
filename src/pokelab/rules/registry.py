"""Two reviewed local interpretations; no discovery, NLP, ingestion or AI."""
...
def evidence(key, kind, reference, field_path, content, retrieved_at=None):
    return Evidence(id=key, kind=kind, reference=reference, field_path=field_path,
        ...
        applicability='International English physical TCG; isolated A/B proof only. No official effective-date claim.')
